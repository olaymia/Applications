...
$('.calculator-btn').click(function () {
    alert("please slecet")
    $('.popup-calculator').addClass('d-block');
    $('.popup-calculator').removeClass('d-none');
});
$('.cancle-calculator').click(function () {
    $('.popup-calculator').removeClass('d-block');
    $('.popup-calculator').addClass('d-none');
});
